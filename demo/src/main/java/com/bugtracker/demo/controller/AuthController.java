...
import com.bugtracker.demo.payload.request.LoginRequest;
import com.bugtracker.demo.payload.request.SignupRequest;
import com.bugtracker.demo.payload.response.JwtResponse;
import com.bugtracker.demo.payload.response.MessageResponse;
import com.bugtracker.demo.repository.RoleRepository;
import com.bugtracker.demo.repository.UserRepository;
import com.bugtracker.demo.security.jwt.JwtUtils;
import com.bugtracker.demo.security.services.UserDetailsImpl;
...
public class AuthController {
	...
	public ResponseEntity<?> registerUser(@Valid @RequestBody SignupRequest signUpRequest) {
		...
		System.out.print("LOOK HERE " +signUpRequest.getEmail()  +" "+signUpRequest.getUsername() );
